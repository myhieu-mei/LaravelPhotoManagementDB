...
<body style="height: 100%; width: 90%; margin: auto; text-align: center;">
    ...
    <br><br>
    <h1 style="text-align: center;">Manage Photos</h1>

    <form action="/admin/photos/create" method="get">
        @csrf
    ...
    <div class="row">
        <table>
            ...
            <tr>
                ...
                <td>{{ $photo->photoDescription->content }}</td>
                
                <td>
                    <form action="{{'/admin/photos/'.$photo->id.'/edit'}}" method="GET">
